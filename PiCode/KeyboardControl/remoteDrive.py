...
class Drive:
    def __init__(self, currentXPos, currentYPos, scaleFactor):
        self.currentXPos = currentXPos
        self.currentYPos = currentYPos
        self.scaleFactor = scaleFactor  #meters/pixel

    def goToPoint(self,xDesired.yDesired):
        euclideanDistance = getEuclideanDist(xDesired,yDesired)
        scaledDistance = getScaledDistance(euclideanDistance)
